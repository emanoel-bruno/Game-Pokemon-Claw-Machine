...
void faz2d();
void faz3d();
//ponto click_mouse(int, int, int, int);
sf::Music menus;
sf::Music subindo;
sf::Music descendo;
sf::Music fogos;
...
{
    menus.openFromFile("PokemonAbertura.wav");
    subindo.openFromFile("subindo.wav");
    descendo.openFromFile("descendo.wav");
    frente.openFromFile("machine_frente.wav");
    direita.openFromFile("machine_frente.wav");
    atras.openFromFile("machine_atras.wav");
    esquerda.openFromFile("machine_atras.wav");
    clike.openFromFile("clico.wav");
    fundo.openFromFile("supermario.wav");
    caindo.openFromFile("caindo.wav");
    caiu.openFromFile("caiu.wav");
    garra_abrindo.openFromFile("drill_raw.wav");
    fogos.openFromFile("fogos.wav");
    //fogos.play();
    fundo.setLoop(true);
    frente.setLoop(true);
...
void mouse_motion(int x, int y)
{
    ...
    //printf("x,y,z %lf,%lf,%lf \n",cordenada_mouse.x,cordenada_mouse.y,cordenada_mouse.z);
    ...
    if(menu==0)
    {
        ...
        if(cordenada_mouse.x<=botao1.x_maximo && cordenada_mouse.x>=botao1.x_minimo)
        {
            if(cordenada_mouse.y<=botao1.y_maximo && cordenada_mouse.y>=botao1.y_minimo)
            {
                ...
                menu=7;
                //menu=6;
                //redimensiona(largura_tela, altura_tela);
            }
        }
...
void posiciona_camera()
{
    ...
    y=cam.y;
    z=cam.z+incremento;
    //printf("%lf, %lf, %lf, %lf fi, %lf teta \n",cam.x,cam.y,cam.z,fi,teta);
